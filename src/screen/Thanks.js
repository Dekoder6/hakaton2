...
export default Thanks = ({ navigation }) => {
    console.log('Thanks =>', navigation)    
    return (
        <View style={{ flex: 1 }}>
                ...
                <View style={{ alignItems: 'center' }}>
                    <View style={styles.content}>
                        <View style={styles.contentDetails}>
                            <Text style={styles.taskBody}><Text style={styles.bodyBody}>ВІТАЄМО </Text></Text>
                            <Text style={styles.titleTask}>Ми  раді, що Ви допустились до співбесіди</Text>
